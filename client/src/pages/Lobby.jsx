...
const Lobby = () => {
  ...
  const handleJoin = (e) => {
    e.preventDefault();
    if (roomId) {
      // In full app, verify room+password with backend first
    ...
    <div className="app-container" style={{ alignItems: 'center', paddingTop: '10vh' }}>
      <header className="app-header" style={{ width: '100%', maxWidth: '800px', marginBottom: '3rem' }}>
        ...
        <div className="user-profile glass-panel" style={{ padding: '0.5rem 1rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <img src="https://robohash.org/test" alt="Avatar" style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(255,255,255,0.1)' }} />
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontWeight: 'bold' }}>Player One</span>
            <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>Level 12 • 45 Wins</span>
          </div>
        </div>
      </header>
